...
private:
	...
	bool set_channel_position(double position, unsigned char address, char channel, int speedLimit);
	...
	//Ackermann
	void AckCB( const ackermann_msgs::AckermannDriveStampedPtr &msg );
	float steer_ang;
	float veh_spd;
